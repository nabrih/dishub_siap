...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?= base_url() ?>assets/adm/img/favicon.ico" type="image/x-icon">
    <link rel="icon" type="image/png" sizes="32x32"  href="<?= base_url() ?>assets/adm/img/favicon-32x32.png">
                                ...
                                <?php echo form_open("auth/login");?>
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <label class="pull-right">
        										<!-- <a href="<?php  // echo base_url() ?>auth/forgot_password">Forgotten Password?</a> -->
        									</label>
