...
class Auth extends CI_Controller
{
	...
	*/
	public function create_menu()
	{
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			$this->load->model('acl_model');
			$menu_id = $this->acl_model->create_menu($this->input->post('menu_name'));
			if ($menu_id) {
	...
	*/
	public function edit_menu($menu_id=false)
	{
		...
		if ($this->form_validation->run() === TRUE){
			$result = $this->acl_model->edit_menu($this->input->post('id'),  $this->form_validation->set_value('menu_name'));
			if ($result) {
